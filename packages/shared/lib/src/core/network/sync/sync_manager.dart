...
class SyncManager {
  ...
  StreamSubscription<QueryResult<Map<String, dynamic>>>? _subscriptionListener;
  ...
  Future<void> _subscribe({
    ...
    _subscriptionListener = _graphqlService
        .subscribeWithSync<Map<String, dynamic>>(
  ...
  void _handleFailure({
    ...
    logger?.info(
      'SyncManager: Retrying in ${delay.inSeconds}s (Attempt $_retryCount/$_maxRetries)',
    );
