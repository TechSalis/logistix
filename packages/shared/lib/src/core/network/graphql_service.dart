...
class GraphQLService {
  ...
  /// Starts a robust subscription that automatically performs a catch-up sync
  /// whenever the connection is established or restored.
  Stream<QueryResult> subscribeWithSync(
    String document, {
    ...
    return subscribe(document, variables: variables);
  }
