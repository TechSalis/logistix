...
class NetworkImageWithAuth
  ...
  @override
  Future<NetworkImageWithAuth> obtainKey(
  ...
  Future<ui.Codec> _loadAsync(
    ...
    try {
      ...
      /// I did all this just to add 1 line of code.
      /// Innovative or Lazy? _
      request.headers.add(
  ...
  bool operator ==(Object other) {
    ...
    return other is NetworkImageWithAuth &&
        other.url == url &&
        other.scale == scale;
  }
