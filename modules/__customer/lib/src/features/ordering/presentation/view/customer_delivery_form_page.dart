...
class CustomerDeliveryFormPage extends StatefulWidget {
  const CustomerDeliveryFormPage({required this.deliveryType, super.key});

  final CustomerDeliveryType deliveryType;

  @override
  State<CustomerDeliveryFormPage> createState() => _CustomerDeliveryFormPageState();
}

class _CustomerDeliveryFormPageState extends State<CustomerDeliveryFormPage> {
  ...
  Future<List<AddressDto>> _searchLocation(String filter, bool isPickup) async {
    final types = isPickup
        ? widget.deliveryType.googlePlaceTypes
  ...
  void _submit() {
    ...
    context.read<DeliveryFormCubit>().submitDelivery(input);
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DeliveryFormCubit, DeliveryFormState>(
      ...
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(title: Text(widget.deliveryType.title)),
          body: Form(
            key: _formKey,
            child: ListView(
              ...
              children: [
                ...
                _buildLocationDropdown(
                  label: widget.deliveryType.locationLabel,
                ...
                Text(
                  widget.deliveryType.payloadLabel,
