...
class RiderActiveDeliveriesSheet extends StatelessWidget {
  const RiderActiveDeliveriesSheet({
  ...
  Widget build(BuildContext context) {
    ...
    return NotificationListener<DraggableScrollableNotification>(
      ...
      child: DraggableScrollableSheet(
        ...
        maxChildSize: 0.8,
        initialChildSize: activeDeliveries.isEmpty ? smallest : 0.35,
        snapSizes: activeDeliveries.isEmpty
            ? [smallest, 0.4]
            : [smallest, 0.35, 0.8],
...
class _EmptyDeliveriesSliver extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class _AnimatedDeliveryCard extends StatelessWidget {
  const _AnimatedDeliveryCard({
  ...
  Widget build(BuildContext context) {
    return TweenAnimationBuilder<double>(
      ...
      child: DeliveryPreviewCard(
        delivery: delivery,
        onTap: () =>
            context.push(RiderRoutes.deliveryDetails(delivery.id), extra: delivery),
        action: delivery.hasPickupPosition
            ? AnimatedScaleTap(
                onTap: () {
