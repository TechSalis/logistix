...
class RiderProfileTab extends StatelessWidget {
            ...
            builder: (context, riderState) {
              return riderState.when(
                ...
                loaded: (rider, orders, isOrdersLoading, location) {
                  return SafeArea(
                    child: _buildProfileContent(context, rider, logoutEvent),
                  );
                },
              );
            },
  ...
  Widget _buildProfileContent(
    ...
    Rider rider,
    AsyncRunner<AppError, void> logoutEvent,
  ) {
    return LogistixEntrance(
      children: [
        ...
        _SettingsSection(logoutEvent: logoutEvent),
...
class _SettingsSection extends StatelessWidget {
  const _SettingsSection({required this.logoutEvent});
  final AsyncRunner<AppError, void> logoutEvent;
